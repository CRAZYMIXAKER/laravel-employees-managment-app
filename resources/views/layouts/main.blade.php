...
<head>
    ...
    {{--    @vite(['resources/sass/app.scss', 'resources/js/app.js', 'node_modules/jquery/dist/jquery.min.js'])--}}
</head>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            {{--            class="collapse"--}}
            <div id="collapseUser" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Mixaker 2023</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
